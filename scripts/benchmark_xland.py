...
def build_benchmark(
    env_id: str, num_envs: int, timesteps: int, benchmark_id: Optional[str] = None
):
...
if __name__ == "__main__":
    ...
    benchmark_fn_single = build_benchmark(
        args.env_id, 1, args.timesteps, args.benchmark_id
    )
    ...
    benchmark_fn_vmap = build_benchmark(
        args.env_id, args.num_envs, args.timesteps, args.benchmark_id
    )
